    ...
    public partial class Form3 : Form
    {
        ...
        private void Form3_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                // Atur properti Member terlebih dahulu SEBELUM memasukkan DataSource.
                // Jika DataSource dipasang duluan, SelectedValue akan mengembalikan objek DataRowView dan memicu error/data tidak keluar.
                cmbProdi.DisplayMember = "NamaProdi"; // Teks yang dilihat oleh user
                cmbProdi.ValueMember = "KodeProdi";   // Nilai asli yang digunakan untuk filter ("TI01", "SI01", dll.)
        ...
        {
            // Validasi: Pastikan user sudah memilih data di ComboBox untuk menghindari NullReferenceException
            ...
            try
            {
                ...
                // Mengirimkan parameter string KodeProdi dan string Tahun 4-digit (misal: "2026")
                ...
                {
                    btnCetak.Enabled = false;
                    MessageBox.Show("Data tidak ditemukan untuk program studi dan tahun masuk tersebut.", "Informasi", MessageBoxButtons.OK, MessageBoxIcon.Information);
                }
            }
            catch (Exception ex)
            {
        ...
        {
            // Validasi sebelum membuka cetakan report
            if (cmbProdi.SelectedValue == null)
            {
                MessageBox.Show("Data filter prodi tidak valid.", "Peringatan", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                return;
            }
